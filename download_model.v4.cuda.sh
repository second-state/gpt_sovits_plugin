...
echo "Download the GPT_Sovits V4"
curl -LO https://huggingface.co/L-jasmine/GPT_Sovits/resolve/main/gpt_sovits_v4.cuda.pt
...
cat > config.json << EOF
{
    ...
    "speaker": [
        {
            "name": "cooper",
            "gpt_sovits_path": "gpt_sovits_v4.cuda.pt",
            "version":"V4",
